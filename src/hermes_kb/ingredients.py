...
INGREDIENT_REGISTRY: dict[str, dict] = {
    ...
    "bourbon": {
        "canonical": "波本威士忌",
        "aliases": ["bourbon whiskey", "波本", "波本威士忌"],
        "category": "base_spirit",
        "abv": 0.40,
        "brands": [],
    },
    "cognac": {
        "canonical": "干邑白兰地",
        "aliases": ["cognac brandy", "干邑白兰地", "法国白兰地"],
        "category": "base_spirit",
        "abv": 0.40,
        "brands": [],
    },
    ...
    "rye_whiskey": {
        "canonical": "黑麦威士忌",
        "aliases": ["rye whiskey", "rye whisky", "黑麦威士忌"],
        "category": "base_spirit",
        "abv": 0.40,
        "brands": [],
    },
    "scotch": {
        "canonical": "苏格兰威士忌",
        "aliases": ["scotch whisky", "scottish whisky", "苏格兰威士忌"],
        "category": "base_spirit",
        "abv": 0.40,
        "brands": [],
    },
    ...
    "dark_rum": {
        "canonical": "黑朗姆酒",
        "aliases": ["黑朗姆", "黑朗姆酒", "dark rum liqueur"],
        "category": "base_spirit",
        "abv": 0.43,
        "brands": [],
    },
    ...
    "triple_sec": {
        "canonical": "白橙力娇酒",
        "aliases": ["triple sec liqueur", "白橙力娇酒", "三秒酒"],
        "category": "modifier",
        "abv": 0.30,
        "brands": [],
    },
