...
共 10 个类别（385 条材料）：
- base_spirit 基酒（59：金酒/威士忌/朗姆/龙舌兰/白兰地/伏特加 等）
- modifier 辅料（199：味美思/苦精/君度/利口酒/汤力水/苏打水 等）
- juice 果汁（41：柠檬汁/青柠汁/橙汁/蔓越莓汁/菠萝汁）
- garnish 装饰（43：橄榄/柠檬片/薄荷叶/樱桃/橙皮）
- wine 葡萄酒与起泡酒（27：香槟/普罗塞克/红葡萄酒/波特酒）
- sake 清酒（5：清酒/纯米酒/本酿造 等）
- vermouth 味美思（4：力林 aperitif/杜林味美思 等，独立于 modifier 以便精确检索）
- ice 冰（5：方冰/碎冰/大冰 等）
- syrup 糖浆（1：薰衣草糖浆，独立于 modifier 以便风味查询）
- spirit 通用烈酒（1：日本烧酒 shochu，未归入 base_spirit 的待扩展类）
